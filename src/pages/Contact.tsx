...
import { Send, Mail, MapPin, Phone, ArrowRight, Github as GitHub, Twitter, Linkedin } from 'lucide-react';
...
export default function Contact() {
  ...
  // Initialize EmailJS
  useEffect(() => {
    emailjs.init("Dzt4SJsdO2p0uk7Td");
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error instanceof TypeError && error.message === 'Failed to fetch') {
        ...
        setErrorMessage('Failed to send message. Please try again later or contact me directly at gowdapavan026@gmail.com');
      }
    } finally {
      setIsSubmitting(false);
    }
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">gowdapavan026@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">+91 7019640513</p>
                  </div>
                </div>
              </div>
